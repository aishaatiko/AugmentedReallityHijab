...
namespace FaceMaskExample
{
    public class FaceMaskExampleMenuItem : MonoBehaviour
    {
        ...
        /// </summary>
        [MenuItem ("Tools/Face Mask Example/Create Hijab Mask Prefab")]
        private static void CreateFaceMaskPrefab ()
        {
            ...
            // Mesh_uv for hijab
            /*Vector2[] uv_2 = new Vector2[4];
            for (int j = 0; j < uv_2.Length; j++)
            {
                uv_2[j].x = vertices_hijab[j].x / width;
                uv_2[j].y = (height - vertices_hijab[j].y) / height;
            }*/
            ...
            // add Create alpha mask texture. for hijab
            ...
            Texture2D alphaMaskTexture = AlphaMaskTextureCreater.CreateAlphaMaskTexture (width, height, facialContourUVPoints, mouthContourUVPoints, rightEyeContourUVPoints, leftEyeContourUVPoints);
